...
void ILI9341_DrawLine(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t c) {
	...
	/* Check for overflow */
	if (x0 >= ILI9341_SCREEN_WIDTH) {
		x0 = ILI9341_SCREEN_WIDTH - 1;
	}
	if (x1 >= ILI9341_SCREEN_WIDTH) {
		x1 = ILI9341_SCREEN_WIDTH - 1;
	}
	if (y0 >= ILI9341_SCREEN_HEIGHT) {
		y0 = ILI9341_SCREEN_HEIGHT - 1;
	}
	if (y1 >= ILI9341_SCREEN_HEIGHT) {
		y1 = ILI9341_SCREEN_HEIGHT - 1;
	}
